...
export default function CartDisplay() {
    ...
    if (cart.length === 0) {
        return (
            <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-12 text-center shadow-sm">
                ...
                <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-4">Your Cart is Empty</h2>
                ...
                <a
                    href="/products"
                    className="inline-flex items-center justify-center px-8 py-3 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-xl transition-all"
                >
                    Browse Products
                </a>
            </div>
    ...
    const handleRequestQuote = () => {
        ...
        const cartSummary = cart.map((item) => `${item.productName} (${item.variant.label}) x ${item.quantity}`).join(", ");

        window.location.href = `/contact?cart=${encodeURIComponent(cartSummary)}`;
    };
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 space-y-4">
                {cart.map((item) => (
                    <div
                        ...
                        className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 shadow-sm hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors"
                    >
                        <div className="flex flex-col sm:flex-row gap-5 items-center sm:items-start">
                            ...
                            <div className="flex-1 w-full text-center sm:text-left">
                                <a
                                    ...
                                    className="text-lg font-bold text-neutral-900 dark:text-neutral-100 hover:text-blue-500 transition-colors block mb-1"
                                >
                                    {item.productName}
                                </a>
                                ...
                                <div className="sm:hidden flex items-center justify-center gap-4 mt-2">
                                    <button
                                        onClick={() => cartActions.updateQuantity(item.variant.sku, item.quantity - 1)}
                                        className="w-8 h-8 rounded-full border border-neutral-200 dark:border-neutral-700 flex items-center justify-center text-neutral-500 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors"
                                    >
                            ...
                            <div className="hidden sm:flex items-center gap-8">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="font-bold tabular-nums min-w-[1.5rem] text-center text-neutral-900 dark:text-neutral-100">
                                        {item.quantity}
                                    </span>
                                    <button
                                        onClick={() => cartActions.updateQuantity(item.variant.sku, item.quantity + 1)}
            ...
            <div className="bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-800 rounded-3xl p-6 lg:p-8 space-y-8 lg:sticky lg:top-36">
                        ...
                        <div className="pt-4 border-t border-neutral-200 dark:border-neutral-700 space-y-2">
                            <div className="flex items-start gap-2 text-blue-600 dark:text-blue-400">
                                ...
                                <p className="text-[11px] font-medium leading-relaxed">
                                    Some items in your cart require custom technical calculation. Submit to receive a full quote.
                                </p>
                            </div>
                        </div>
                    )}
                ...
                <div className="space-y-3 pt-4">
                    ...
                    <button
                        onClick={() => {
                            if (confirm("Clear your cart?")) cartActions.clearCart();
                        }}
                ...
                <div className="bg-white dark:bg-neutral-800 p-4 rounded-xl border border-neutral-100 dark:border-neutral-700">
                    ...
                    <p className="text-xs text-neutral-500 leading-relaxed">
                        ...
                        <span className="text-neutral-700 dark:text-neutral-300 font-bold">2 business hours</span> for corporate clients.
                    </p>
                </div>
            </div>
        </div>
